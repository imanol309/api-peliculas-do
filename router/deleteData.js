...
deleteData.delete("/:id", isAuthSecret, async (req, res) => {
...
deleteData.patch("/comments/:id", isAuthSecret, async (req, res) => {
...
deleteData.delete("/masVistas/:id", isAuthSecret, async (req, res) => {
  const id = req.params.id;
  try {
